...
Global = {
    ...
    clearAll :function(){
        ...
        for (var i=0; i<this.intervals.length; i++) {
            window.clearInterval(this.intervals[i]); // clear all the intervals
        }
...
function FullScreenMario() {
  ...
  window.requestAnimationFrame = window.requestAnimationFrame
                           ...
                           || function(func) { Global.setTimeout(func, timer); };
...
function resetMeasurements() {
  resetUnitsize(4);
  resetTimer(1000 / 60 / 2);
  // setInterval(function(){
  // if (timer<6){resetTimer(1000 / 60 / 2);}
  // else if(timer<10){resetTimer(1000 / 60);}
  // else{resetTimer(1000 / 60 / 4);}},10000);
  // setInterval(function(){
  //   pause();
  //   setTimeout(function(){
  //     unpause();
