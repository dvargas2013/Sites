...
function passivelyLoadMap(map, ajax) {
  ...
  // Maps/WorldXY.js
  var url = "http://supermarioemulator.com/mario.php/Maps/World" + map[0] + "" + map[1] + ".js"
  ...
  ajax.onreadystatechange = function() {
    ...
    if(ajax.status == 200) {
      ...
      if(window.parentwindow && parentwindow.onmapload) {
        ...
        Global.setTimeout(function() { parentwindow.onmapload(map[0],map[1]); }, 2100); // just in case
      }
    ...
    Global.setTimeout(function() { passivelyLoadMap(setNextLevelArr(map), ajax); }, 7);
  };
}
...
function startLoadingSounds() {
  ...
  Global.setTimeout(function() { loadSounds(libsounds, library.sounds.names, "http://supermarioemulator.com/Sounds/"); }, 7);
  Global.setTimeout(function() { loadSounds(libsounds, library.sounds.themes, "http://supermarioemulator.com/Sounds/Themes/"); }, 14);
}
