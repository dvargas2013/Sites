...
function magicIndex(st) {
	var i = '!,.0123456789?ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'.indexOf(st);
	return [ 44*(i%11),35*Math.floor(i/11) ];
}
function change() {
	...
	for (var i=0; i<lis.length; i++) {
		...
		lis[i].innerHTML = '<div style="background: url(img.png); width: 44px; height: 35px;">'+lis[i].innerText+'</div>'
